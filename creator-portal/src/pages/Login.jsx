    ...
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-8 text-center shadow-2xl shadow-black/40">
        <img
          src={ascendusIcon}
          alt="Ascendus"
          className="mx-auto mb-6 h-16 w-16 mix-blend-screen"
        />
        ...
        <button
          ...
          className="mt-8 flex w-full items-center justify-center gap-2 rounded-lg bg-gold px-4 py-2.5 text-sm font-semibold text-black transition-opacity hover:opacity-90"
        >
