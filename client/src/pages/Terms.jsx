  ...
  return (
    <div className="page-scroll-full" style={{ background: '#080808' }}>
      <div style={{ borderBottom: `1px solid ${BORDER}` }}>
        <PageHeader title="Terms of Service" subtitle="Last updated: April 2025" back />
      </div>
      ...
      <div className="px-5 py-6 pb-20 max-w-2xl mx-auto">
        ...
        <Section title="6. Subscriptions & Payments">
          <p><strong style={{ color: TEXT }}>Billing:</strong> Ascendus Premium is billed at $9.99/month or $49.99/year (prices shown at checkout). You will be clearly informed of the exact charge before confirming your subscription.</p>
