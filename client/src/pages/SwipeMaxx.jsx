...
export default function SwipeMaxx() {
  ...
  async function handleAnalyze() {
    ...
    setResult(null)
    try {
      const data = await api.swipemaxx.rank({
      ...
      if (err.plan === 'premium') {
        navigate('/premium?from=swipemaxx')
      } else {
  ...
  return (
    <MotionPage className="px-4 pb-8">
      <PageHeader title="SwipeMaxx" subtitle="Find your best dating photo" />
